...
#define VLIGHTGRAY      "LIGHTGREY"   // "0xb3b3b3"    // no defined color, hand made ;-)
#define LIMEGREEN       "LIMEGREEN"   // "0x32cd32"
#define FORESTGREEN     "FORESTGREEN" // "0x228b22"
#define FIREBRICK       "FIREBRICK"   // "0xb22222"
#define DODGERBLUE      "DODGERBLUE"  // "0x0A7CEB"    // EV charging // 0x0A7CEB = "um -20 dunkleres dogerblue" (Orig. 0x1e90ff)
